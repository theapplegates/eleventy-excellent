...
export const author = {
  ...
  website: 'https://paulapplegaet.com', // i.e. https.://www.lenesaile.com - the personal site of the author
  fediverse: 'https://front-end.social/' // used for highlighting journalism on the fediverse. Can be Mastodon, Flipboard, Threads, WordPress (with the ActivityPub plugin installed), PeerTube, Pixelfed, etc. https://blog.joinmastodon.org/2024/07/highlighting-journalism-on-mastodon/
};
